export interface DataEntry {
  ...
  const myData: DataEntry[] = [
    {
      ...
      answer: "Neil Carlo Nabor is a 21-year-old born on January 8th, 2000, who loves video games, novels, and voice acting. He is the creator of John AI. That's me!",
      category: "identity",
    ...
    },
    {
      ...
      answer: "Neil Carlo Nabor is a 21-year-old born on January 8th, 2000, who loves video games, novels, and voice acting. He enjoys playing video games, reading novels, and voice acting. His favorite foods are anything with coconut milk and spicy foods. Neil’s favorite video games are Baldur’s Gate 3, Undertale, and Terraria. He loves the band Panic! At The Disco. He is the creator of John AI. That's me!",
      category: "overview",
  ...
  export function generateFlexibleAnswer(query: string): { answer: string; confidence: number } {
    ...
    if (overviewEntry && calculateStringSimilarity(query.toLowerCase().replace(/[^a-z0-9\s]/g, ''), overviewEntry.question.toLowerCase().replace(/[^a-z0-9\s]/g, '')) > 0.4) {
    ...
    if (relevantEntries.length > 0) {
      ...
      if (calculateStringSimilarity(query.toLowerCase().replace(/[^a-z0-9\s]/g, ''), relevantEntries[0].question.toLowerCase().replace(/[^a-z0-9\s]/g, '')) > 0.6) {
